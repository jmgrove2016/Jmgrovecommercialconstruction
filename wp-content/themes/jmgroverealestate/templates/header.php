...
<div id="left-logo"><?php avada_logo(); ?></div>
...
<!--
                       <div class="linkss">
                            ...
                            <li><a href="http://jmgrovebuildingsupply.com/">Home</a></li>

                        	<li><a href="http://jmgrovebuildingsupply.com/about-jmgrove/">About us</a></li>

                            <li><a href="#">Rewards/Gift Cards</a></li>

                            <li><a href="#">Order Status</a></li>

                            <li><a href="#">Pro Sales</a></li>
...
<!--                        	<img src="<?php echo home_url(); ?>http://localhost/jmgroverealestate/wp-content/uploads/2016/02/above-address.png" />-->
                            <p><b>(215) 274-5182</b> <br/>72 Lancaster Ave, <br/>  <b>Malvern, PA 19355</b> <br/> Service-Sales@jmgroveconstruction.com</p>
                        ...
                        <div class="riight">
                            <div class="header-top-section">
                                ...
                                <div class="save-button"><a  href="#">Sign In</a></div>
                            ...
                            <div class="header-bottom-section">
                                ...
                                <div class="sign-in"><a  href="#">Sign Up</a></div>
                            </div>
...
<!--
                        ...
                        <?php }
                            ...
                            <span><a href="<?php echo home_url(); ?>/login">Sign In</a> / <a href="<?php echo home_url(); ?>/register">Sign Up</a></span>

							<?php }?>

                            

                            <p><a href="<?php echo home_url(); ?>/my-account">My Account</a></p>

                            <p><a href="<?php echo home_url(); ?>/wishlist">Wish List</a></p>
-->
		...
		<div class="fusion-sticky-header-wrapper"> <!-- start fusion sticky header wrapper -->
			...
			<div class="fusion-header">
				...
				<div class="fusion-row">
                    ...
                    <div id="left-logo"><a href="<?php echo home_url(); ?>"><img src="<?php echo home_url(); ?>/wp-content/uploads/2016/02/logo.jpg" width="100%" id="catch-first" />  <img src="<?php echo home_url(); ?>/wp-content/uploads/2016/02/jg-grove.jpg" width="100%" id="catch-sceond" /></a></div>
...
-->
                    ...
                    <div id="header-address">
                    	...
                    	<div class="leeft">
                        	...
                        	<img src="<?php echo home_url(); ?>/wp-content/uploads/2016/02/above-address.jpg" /><br />

                            <p>72 Lancaster Ave</p>
...
<!--MOBILE HEADER-->
	...
	<div id="four-buttons">
	<ul>
    	<li>Your Store: <span>72 Lancaster Ave Malvern Pa 19355</span></li>        
        ...
        <li><?php if(is_user_logged_in())
                        ...
                        <?php }
                           ...
                           <a href="<?php echo home_url(); ?>/login">Sign In</a> /<br/> <a href="<?php echo home_url(); ?>/register">Sign Up</a>
...
if ( ! function_exists( 'avada_header_social_links' ) ) {
	...
	function avada_header_social_links() {
		...
		$options = array(
			...
			'icon_boxed_radius' => intval( Avada()->settings->get( 'header_social_links_boxed_radius' ) ) . 'px',
...
if ( ! function_exists( 'avada_mobile_main_menu' ) ) {
	...
	function avada_mobile_main_menu() {
		...
		if ( 'right' == Avada()->settings->get( 'mobile_menu_text_align' ) ) {
			...
			$mobile_menu_text_align = ' fusion-mobile-menu-text-align-right';
		...
		printf( '<div class="fusion-mobile-nav-holder%s"></div>', $mobile_menu_text_align );
